...
function introState () {
	...
	function preload() {
		...
		this.game.load.image('towerup', 'assets/intro-animation/tower-up.png');
		this.game.load.image('towerdown', 'assets/intro-animation/tower-down.png');
	...
	function create () {
		...
		var prince = this.game.add.sprite(this.game.world.centerX - 200, this.game.world.centerY/2, 'prince');
		prince.animations.add('act');
		prince.animations.play('act', 2, true);
		this.game.time.events.add(Phaser.Timer.SECOND * 4.1, function () {addFrame(this, 'bg-sky', 6.3, this.game.world.centerX - 200, this.game.world.centerY/2, 'towerup')}, this);
		this.game.time.events.add(Phaser.Timer.SECOND * 6.3, function () {addFrame(this, 'bg-grass', 11.7, this.game.world.centerX - 200, this.game.world.centerY/2, 'towerdown')}, this);
		this.game.time.events.add(Phaser.Timer.SECOND * 11.7, function () {addFrame(this, 'bg-closetower', 15, this.game.world.centerX - 200, this.game.world.centerY/2, 'princesslooking')}, this);
		this.game.time.events.add(Phaser.Timer.SECOND * 15, function () {addFrame(this, 'bg-woods', 18, this.game.world.centerX - 200, this.game.world.centerY/2, 'hada')}, this);
		this.game.time.events.add(Phaser.Timer.SECOND * 18, function () {addFrame(this, 'bg-woods', 20.6, this.game.world.centerX - 200, this.game.world.centerY/2, 'mouse')}, this);
		this.game.time.events.add(Phaser.Timer.SECOND * 18, function () {addFrame(this, 'bg-fartower', 20.6, this.game.world.centerX - 200, this.game.world.centerY/2, 'princessgrabbed')}, this);
		this.game.time.events.add(Phaser.Timer.SECOND * 20.6, function () {addFrame(this, 'bg-sky', 25, this.game.world.centerX - 200, this.game.world.centerY/2, 'flyingprincess')}, this);
		this.game.time.events.add(Phaser.Timer.SECOND * 25, startGame, this);


	}

	function addFrame (that, bgimage, timeOnStage, spriteX, spriteY, sprites) {
